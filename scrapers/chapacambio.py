...
async def scrap_chapacambio():
    ...
    endpoint = "https://chapacambio.com/wp-json/chapacambio/tasas"
    ...
    try:
        ...
        if not isinstance(data, list) or not data:
            return {
                ...
                "venta": None,
                "estado": "error",
                "error": "Respuesta inesperada (lista vacía).",
            }

        item = data[0]
        compra_raw = item.get("MontoCompra")
        venta_raw  = item.get("MontoVenta")
